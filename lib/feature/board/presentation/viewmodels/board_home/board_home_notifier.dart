import 'package:board/feature/board/data/models/board_home/board_home_model.dart';
...
class BoardHomeNotifier extends StateNotifier<List<BoardHomeViewModel>> {
  final IBoardUsecase _boardUsecase;
  final Ref ref;

  BoardHomeNotifier(this._boardUsecase, this.ref) : super([]);
  ...
  Future<void> loadBoardContents() async {
    ...
    state = List<BoardHomeViewModel>.from(jsonData['boardContents'].map((x) =>
        BoardHomeViewModel.fromEntity(BoardHomeModel.fromJson(x).toEntity())));
  }
